...
function DashboardContent() {
  ...
  return (
    <div className="w-full max-w-[1280px] mx-auto px-6 lg:px-10 mt-8 lg:mt-16 flex-1 flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between gap-12 lg:gap-8 pb-12 lg:pb-32">
      {/* Left Column - Hero */}
      <div className="w-full lg:max-w-[55%] pt-2 relative z-20">
        {/* Built For Badge */}
        ...
        <p className="text-[14px] md:text-[15px] text-[#555f76] mb-10 leading-relaxed max-w-[520px]">
          Paste a YouTube channel URL to uncover top-performing videos, breakout
          Shorts, and content patterns.
        </p>
        ...
        <div className="bg-white p-5 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 mb-8 relative max-w-[540px]">
          <label className="block text-[11px] font-bold text-[#555f76] mb-2 px-1">
            Channel URL
          </label>
          <form
            onSubmit={(e) => {
              ...
              if (inputValue)
                router.push(
                  "/results?channel=" + encodeURIComponent(inputValue),
                );
            }}
          ...
          <div className="hidden sm:block mt-3 text-[11px] text-[#8e98ac] px-1 font-medium">
            You can paste a full YouTube channel URL or just the @handle to
            instantly reveal what is working right now.
          </div>
        </div>

        {/* Sample Channels */}
        <div className="max-w-[540px]">
          <h3 className="text-[11px] font-bold text-[#8e98ac] mb-3 ml-1 tracking-wide">
            Suggested sample channels
          </h3>
          <div className="flex flex-wrap gap-2.5 mb-6">
            <button
              type="button"
              onClick={() => setInputValue("https://www.youtube.com/@mkbhd")}
              className="text-left px-4 py-3 bg-white border border-gray-100 rounded-[14px] shadow-[0_4px_12px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)] hover:border-gray-200 transition-all"
            >
            ...
            <button
              type="button"
              onClick={() => setInputValue("https://www.youtube.com/@Fireship")}
              className="text-left px-4 py-3 bg-white border border-gray-100 rounded-[14px] shadow-[0_4px_12px_rgba(0,0,0,0.02)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.05)] hover:border-gray-200 transition-all"
            >
              <div className="font-bold text-[12px] text-gray-900">
                Fireship
            ...
            <button
              type="button"
              onClick={() =>
                setInputValue("https://www.youtube.com/@ColinAndSamir")
              }
              className="text-left px-4 py-3 bg-white border border-gray-100 rounded-[14px] shadow-[0_4px_12px_rgba(0,0,0,0.01)] transition-all"
            >
              <div className="font-bold text-[12px] text-gray-900">
                Colin and Samir
              </div>
      ...
      <div className="hidden lg:block w-full lg:w-[420px] xl:w-[460px] flex-shrink-0 relative mt-4 lg:mt-2">
        <div className="bg-white rounded-[24px] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-gray-100/80 p-5 md:p-6 transform sm:scale-95 origin-top lg:origin-top-left xl:scale-90 xl:w-[110%]">
          ...
          <div className="flex gap-2.5 mb-7">
            ...
            <div className="flex-[1.4] border border-[#f1f5f9] rounded-[14px] p-4 bg-white shadow-[0_4px_12px_rgba(0,0,0,0.02)]">
              ...
              <div className="text-[15px] font-bold text-gray-900 leading-none truncate mt-[5px]">
                Client results
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((num) => (
              <div
                key={num}
                className="border border-[#f1f5f9] p-3 rounded-[20px] flex gap-4 items-center bg-white shadow-[0_4px_12px_rgba(0,0,0,0.015)]"
              >
                {/* Thumbnail mock */}
                ...
                <div className="flex-1 space-y-3.5 pr-2">
                  <div
                    className={`h-2.5 bg-[#e2e8f0] rounded-full ${num === 1 ? "w-full" : num === 2 ? "w-[85%]" : "w-[75%]"}`}
                  ></div>
